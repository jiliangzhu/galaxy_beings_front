...
class ContractAdmin extends Component {
    constructor(props) {
        ...
        this.inputAlienPrice = this.inputAlienPrice.bind(this)
        this.setAlienPrice = this.setAlienPrice.bind(this)
    ...
    alienPrice(){
        let that = this
        MyWeb3.alienPrice().then(function (alienPrice) {
            that.setState({alienPrice:alienPrice})
        })
    }
    setAlienPrice(){
        MyWeb3.setAlienPrice(this.state.alienPrice).then(function (res) {
            console.log(res)
            window.location.reload()
        })
    }
    inputAlienPrice(event){
        this.setState({
            alienPrice:event.target.value
        })
    }
                    ...
                    <dl>
                        ...
                        <dd>
                            <input 
                                type="text" 
                                id='alienPrice'
                                value={this.state.alienPrice}
                                onChange={this.inputAlienPrice}>
                            </input>
                            <button className="pay-btn pay-btn-last" onClick={this.setAlienPrice}>
                                <span>
                                    设置
                                </span>
                            </button>
